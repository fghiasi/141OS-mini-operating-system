...
/*
03.10.2020
End up reverting back to using the Main class to handle JavaFX
 */
public class GraphicalUserInterface extends Application {
    ...
    private GraphicalUserInterface(OperatingSystem os){
        this.os = os;
    }

    //Singleton
    public static GraphicalUserInterface getInstance(OperatingSystem os){
        if(graphicalUserInterface == null){
            graphicalUserInterface = new GraphicalUserInterface(os);
        }
